...
def depth_first_graph_search(problem): #, h, display=True
    """
    [Figure 3.7]
    Search the deepest nodes in the search tree first.
    Search through the successors of a problem to find a goal.
    ...
    """
    frontier = [(Node(problem.initial))]  # Stack
    # h = memoize(h or problem.h, 'h') # added
...
def breadth_first_graph_search(problem): #arguments changed, , h, display=True
    """[Figure 3.11]
